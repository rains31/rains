...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey, "Shift"   }, "p", function () awful.util.spawn("/home/rains/.screenlayout/1080x1920.sh")  end),
    awful.key({ modkey            }, "p", function () awful.util.spawn("/home/rains/.screenlayout/1920x1080.sh")  end),
    awful.key({ modkey,           }, "l",     function () awful.util.spawn("slock")     end),
    awful.key({ modkey,           }, "c",     function () awful.util.spawn("pass -c knownsec")     end),
    awful.key({ "Control","Mod1"   }, "Down",     function () awful.util.spawn("xrandr -o 0")     end),
    awful.key({ "Control","Mod1"   }, "Left",     function () awful.util.spawn("xrandr -o 1")     end),
    awful.key({ "Control","Mod1"   }, "Up",     function () awful.util.spawn("xrandr -o 2")     end),
    awful.key({ "Control","Mod1"   }, "Right",     function () awful.util.spawn("xrandr -o 3")     end),
    awful.key({ modkey,            }, "Print", function () awful.util.spawn("xfce4-screenshooter")     end),
--    awful.key({                   }, "XF86Launch1", function () awful.util.spawn("terminator -e up")     end),
    awful.key({                   }, "XF86Display", function () awful.util.spawn("disper --cycle-stages='-s : -e : -c : -S' --cycle")     end),
    awful.key({                   }, "XF86RotateWindows", function () awful.util.spawn("env DISPLAY=:0 /usr/bin/thinkpad-rotate")     end),
    awful.key({                   }, "XF86TaskPane", function ()  awful.util.spawn("sudo pm-suspend")   end),
    ...
    -- Menubar
    awful.key({ "Mod1" }, "r", function () awful.util.spawn("kupfer")     end),
    awful.key({ modkey }, "x",
              function ()
